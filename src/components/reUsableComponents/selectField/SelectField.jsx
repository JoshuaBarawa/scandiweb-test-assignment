...
function SelectField(props){
    ...
    <div className="select-group">
        ...
        <select name={name} id="productType" className='select-control' required={required} value={value} onChange={handleChange} onBlur={handleFocus} focused={focused.toString()}>
